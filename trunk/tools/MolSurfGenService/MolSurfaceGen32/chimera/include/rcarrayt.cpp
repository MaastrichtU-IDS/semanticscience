...
void Array<T>::get_values(T *v) const
{
  ...
  int k = 0;
  int i0, j0, js0 = stride(0), s0 = size(0);
  if (dimension() == 1)
    {
  ...
  int i1, j1, js1 = stride(1), s1 = size(1);
  if (dimension() == 2)
    {
      for (i0=0, j0=0 ; i0<s0 ; ++i0, j0+=js0)
  ...
  int i2, j2, js2 = stride(2), s2 = size(2);
  if (dimension() == 3)
    {
      for (i0=0, j0=0 ; i0<s0 ; ++i0, j0+=js0)
	for (i1=0, j1=j0 ; i1<s1 ; ++i1, j1+=js1)
  ...
  int i3, j3, js3 = stride(3), s3 = size(3);
  if (dimension() == 4)
    {
      for (i0=0, j0=0 ; i0<s0 ; ++i0, j0+=js0)
	for (i1=0, j1=j0 ; i1<s1 ; ++i1, j1+=js1)
...
void Array<T>::set(const Array<S> &a)
{
  ...
  int i0, j0, js0 = stride(0), k0, ks0 = a.stride(0);
  ...
  int i1, j1, js1 = stride(1), k1, ks1 = a.stride(1);
  ...
  int i2, j2, js2 = stride(2), k2, ks2 = a.stride(2);
  ...
  int i3, j3, js3 = stride(3), k3, ks3 = a.stride(3);
