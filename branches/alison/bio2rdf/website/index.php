...
<head>
 ...
 <script src="js/jquery.table_navigation.js"></script>
 ...
 <script type="text/javascript">
	$(document).ready(function(){
		 ...
		 $("#search-form").submit(function(){
		  ...
		  $(".searchInput").typeWatch({highlight:false,callback:searchIndex, wait:450, captureLength:0});
	});//onReady
 </script>
...
<body>
 <div id="content">
  ...
  <div class="search">
   <form id="search-form">
    <div id="inputWrapper">
     <input id="input" type="text" size="35" id="inputString"  class="searchInput" autocomplete="off"/>
