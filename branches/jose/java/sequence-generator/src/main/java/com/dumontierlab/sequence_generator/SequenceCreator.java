...
public class SequenceCreator {
	...
	/**
	 * String containing all four (A,C,U(T),G) characters
	 * in the desired proportions from where a random draw
	 * will be made to create random sequences
	 */
	...
	/**
	 * A random nucleotide sequence that follows the 
	 * required proportions and length
	 */
	 ...
	 * @param molType specifies the type of molecule RNA|DNA
	 */
	 ...
	 * @param molType specifies the type of molecule RNA|DNA
	 * @param props HashMap that specifies the desired proportions of the generated sequence
	 * @param seqLen length of the output sequence
	 */
	...
	/**
	 * This method will populate nucleotidePool according
	 * to the proportions specified in proportions
	 */
	...
	/**
	 * This method sets a random sequence that follows
	 * the same proportions as the nucleotide pool
	 */
